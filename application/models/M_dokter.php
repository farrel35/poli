...
class M_dokter extends CI_Model
{
    ...
    {
        $this->db->select('tbl_daftar_poli.id, tbl_daftar_poli.keluhan, tbl_daftar_poli.no_antrian, tbl_pasien.nama as nama_pasien, tbl_periksa.tgl_periksa, tbl_periksa.catatan, tbl_periksa.biaya_periksa');
